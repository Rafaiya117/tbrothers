...
import 'package:appsoleum/features/legacy_create_capsule/custom_widget/image_uploader.dart';
...
class LegacyCapsuleAddMedia extends StatelessWidget {
  const LegacyCapsuleAddMedia({super.key});
                ...
                child: Column(
                  ...
                  Consumer<LegacyCreateCapsuleController>(
                    builder: (context, controller, _) {
                      return ImageUploaderView(controller: controller);
                    },
                  ),
                ],
              ),
                    ...
                    builder: (context, controller, _) {
                      return SizedBox(
                        ...
                        child: CustomRoundedButton(
                          text: "Next",
                          backgroundColor: controller.images.isEmpty? FontColors.disabled_buttonColor: FontColors.button_color,
                          textColor:controller.images.isEmpty?FontColors.disable_text: Colors.white,
                          onPressed: controller.images.isEmpty
                            ? null: () {
                            context.push('/legacy_capsule_addnote');
                          },
                        ),
                      );
                    },
