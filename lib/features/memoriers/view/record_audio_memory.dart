...
class RecordAudioMemory extends StatefulWidget {
  const RecordAudioMemory({super.key});

  @override
  State<RecordAudioMemory> createState() => _RecordAudioMemoryState();
}

class _RecordAudioMemoryState extends State<RecordAudioMemory> {
  @override
   Widget build(BuildContext context) {
    final recordingController = Provider.of<RecordAudioMemoryController>(context);
                                    ...
                                    recordingController.formatDuration(
                                      Duration(
                                        milliseconds: (recordingController.progress *
                                          RecordAudioMemoryController.maxDuration.inMilliseconds).toInt(),
                                      ),
                                    ),
