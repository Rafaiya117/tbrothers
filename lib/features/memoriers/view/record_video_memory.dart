...
import 'package:appsoleum/features/memoriers/widget/record_panel.dart';
...
class RecordVideoMemory extends StatefulWidget {
  const RecordVideoMemory({super.key});

  @override
  State<RecordVideoMemory> createState() => _RecordVideoMemoryState();
}

class _RecordVideoMemoryState extends State<RecordVideoMemory> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final recordingController = Provider.of<RecordVideoMemoryController>(context, listen: false);
      recordingController.initCamera();
    });
  }
  @override
  Widget build(BuildContext context) {
    final recordingController = Provider.of<RecordVideoMemoryController>(context);
                                  ...
                                  Text(
                                    recordingController.formatDuration(
                                      Duration(
                                        ...
                                        RecordVideoMemoryController.maxDuration.inMilliseconds).toInt(),
                                      ),
                                    ),
